...
ActiveRecord::Schema.define(version: 2020_10_02_101329) do
  ...
  create_table "prototyapes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title"
    t.text "catch_copy"
    t.text "concept"
    t.bigint "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_prototyapes_on_user_id"
  end
  ...
  add_foreign_key "prototyapes", "users"
